 ...
 */
public class FloorObject implements GameObject {

        org.acebot.impl.FloorObject object;
        Tile location;

        public FloorObject(org.acebot.impl.FloorObject floorDecoration, int x, int y) {
                object = floorDecoration;
        ...
        public org.acebot.impl.FloorObject getObject() {
                return object;
        }
        ...
        public ObjectDefLoader getObjectDefLoader() {
                return object.getDefLoader();  //To change body of implemented methods use File | Settings | File Templates.
        }
